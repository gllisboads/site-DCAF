...
- **IV** – Proceder às **reestimativas fiscais**, aptas a antecipar cenários fiscais, para fornecer subsídios necessários à compatibilização permanente de receitas e despesas;
- **V** – Manter articulação com as **unidades competentes da Administração Pública estadual**, visando à obtenção de informações necessárias à elaboração de projeções de receitas e despesas;
- **VI** – Acompanhar, em conjunto com a SEF, no decorrer do exercício, os **limites constitucionais e legais pertinentes** e propor medidas necessárias para o seu cumprimento;
- **VII** – Elaborar **reestimativa de despesas de pessoal**, e indicar a alocação de fontes de recursos para a apropriação da folha de pessoal;
- **VIII** – Gerir o **ementário das classificações orçamentárias da receita** e acompanhar tempestivamente suas eventuais alterações e atualizações;
